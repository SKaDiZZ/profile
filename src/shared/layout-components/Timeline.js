    ...
    <div className="container" id="timeline">
      ...
      <div className="flex flex-col md:grid grid-cols-9 mx-auto p-2 text-blue-50">
        <div className="flex flex-row-reverse md:contents">
          <div className="bg-card-bg col-start-1 col-end-5 p-4 rounded-xl my-4 ml-auto shadow-md">
        ...
        <div className="flex md:contents">
          ...
          <div className="bg-card-bg col-start-6 col-end-10 p-4 rounded-xl my-4 mr-auto shadow-md">
            <h4 className="text-xl font-bold text-main-brand flex items-center mb-2">
              2015 - 2019
            </h4>
            <h3 className="font-semibold text-lg mb-4">
        ...
        <div className="flex md:contents">
          ...
          <div className=" col-start-6 col-end-10 p-4 rounded-xl my-4 mr-auto">
            ...
            <h3 className="font-semibold text-lg mb-4">I became a father</h3>
            <img src={baby} alt="samir i adela" />
          </div>
        </div>
        ...
        <div className="flex md:contents">
          ...
          <div className=" col-start-6 col-end-10 p-4 rounded-xl my-4 mr-auto">
            ...
            <h3 className="font-semibold text-lg mb-4">Happily Married</h3>
            <img src={samiriadela} alt="samir i adela" />
          </div>
        </div>
